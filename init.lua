...
vim.keymap.set("i", "{", "{}<Esc>ha", { desc = "Automatically close curly brace" })
vim.keymap.set("i", "[", "[]<Esc>ha", { desc = "Automatically close square bracket" })
vim.keymap.set("i", "(", "()<Esc>ha", { desc = "Automatically close bracket" })
